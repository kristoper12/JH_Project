...
#define NUM_LEARN_PATTERN				11
#define NUM_PREDICT_PATTERN				11
#define NUM_PREDICT_PATTERN_FLOAT		11.0

#define NUM_EPOCH						5000000
#define LEARNING_RATE					0.001
#define LEARNING_PATTERN_FLOAT			0.6
...
float GetRadian(float num);							// Radian 받는 함수
...
void main() {
	...
	int k = 0;
	for (float i = 0.0; i < 6.3; i = i + LEARNING_PATTERN_FLOAT) {
		input[k][0] = i;
		Quiz[k++][0] = i;
	}
	k = 0;
	/*for (float i = 0.0; i < 6.3; i = i + 0.1) {
		Quiz[k++][0] = i;
		printf("%.1f\t", Quiz[k - 1][0]);
	}*/
